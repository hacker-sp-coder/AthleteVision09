  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      await setDoc(doc(db, "users", user.uid), {
        ...
        primarySport: formData.primarySport || 'Volleyball',
        district: formData.district || '',
        state: formData.state || '',
      ...
      <div className="sih-card">
        ...
        <form onSubmit={handleSubmit} className="sih-form">
          <div className="input-wrapper">
            ...
            <input className="sih-input" type="text" name="name" placeholder="Enter your full name" onChange={handleChange} required />
          </div>
          ...
          <div className="form-grid-2">
            ...
            <div className="input-wrapper">
              ...
              <input className="sih-input" type="password" name="password" placeholder="Create a password" onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="form-grid-2">
            <div className="input-wrapper">
              ...
              <input className="sih-input" type="date" name="dob" onChange={handleChange} required />
            </div>
            <div className="input-wrapper">
          ...
          <div className="form-grid-2">
            <div className="input-wrapper">
              ...
              <select className="sih-input" name="gender" onChange={handleChange}>
            ...
            <div className="input-wrapper">
              ...
              <select className="sih-input" name="primarySport" onChange={handleChange}>
          ...
          <div className="form-grid-2">
            <div className="input-wrapper">
              ...
              <input className="sih-input" type="text" name="district" placeholder="District" onChange={handleChange} required />
            </div>
            <div className="input-wrapper">
              <label className="input-label">State</label>
              <input className="sih-input" type="text" name="state" placeholder="State" onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="form-grid-2">
            <div className="input-wrapper">
              ...
              <input className="sih-input" type="number" name="heightCm" placeholder="178" onChange={handleChange} required />
            </div>
            <div className="input-wrapper">
              <label className="input-label">Weight (kg)</label>
              <input className="sih-input" type="number" name="weightKg" placeholder="68" onChange={handleChange} required />
            </div>
          </div>
